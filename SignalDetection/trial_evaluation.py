...
class TrialEvaluation:
    ...
    def response_name(self, argument):
        ...
        if argument == 1:
            ...
            self.stimulus_present = 1
        if argument == 2:
            self.answer = "False Alarm";
            self.subject_response = 1
            self.stimulus_present = 2
        if argument == 3:
            self.answer = "Correct Rejection";
            self.subject_response = 2
            self.stimulus_present = 2
        if argument == 4:
            self.answer = "Miss"
            self.subject_response = 2
        ...
        b = self.answer, self.subject_response, self.stimulus_present
        print(4, b)
        return b