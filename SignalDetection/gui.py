...
#        os.chdir(self.this_dir)
        ...
        self.gui_input.addField("Versuchsperson:","JOSU26")  # 0
    ...
    def set_variables(self, experiment_type):
        ...
        self.gui_input_var.addField("Trialanzahl", 40)  # 0
        self.gui_input_var.addField("Anzahl der Trialblocks", 1)  # 1
        self.gui_input_var.addField("Anzahl der Testtrials", 0)  # 2
        self.gui_input_var.addField("Dauer Fixationskreuz", 0.1)  # 3
        self.gui_input_var.addField("Dauer Maske:", 0.1)  # 4  # blanc screen 
        self.gui_input_var.addField("Dauer Stimulus", 0.1)  # 5
        self.gui_input_var.addField("Dauer Antwortperiode", 0.9)  # 6
        self.gui_input_var.addField("Dauer Feedback", 0.1)  # 7
        self.gui_input_var.addField("Dauer Pause", 0.2)  # 8
        ...
        self.gui_input_var.addField("Zufällig", False)  #17
        self.gui_input_var.addField("Automatisch", False) #18
        if experiment_type != "Constant Stimuli":
            self.gui_input_var.show()
